 ...
 * @LastEditTime: 2021-11-17 16:47:29
...
const Suit SuitValue[DIAMONDS + 1] = {SPADES, HEARTS, CLUBS, DIAMONDS};

const Spot SpotValue[ACE + 1] = {TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, TEN,
                                 JACK, QUEEN, KING, ACE};
